...
class WindowMediaText extends WindowMediaBase {
    ...
    **/
    public function new(ac:Dynamic, mode:String) {
        // creating window
        super(ac, Global.ln.get('window-mdtext-title'), 'text', mode);
    }
    ...
    **/
    override public function startInterface(evt:Event = null):Void {
        ...
        this.addForm(Global.ln.get('window-mdtext-title'), this.ui.forge('leftcol', [
            { tp: 'Label', id: 'about', tx: Global.ln.get('window-mdtext-about'), vr: '' }, 
            { tp: 'TArea', id: 'text', tx: '', vr: '', en: true }, 
            { tp: 'Button', id: 'btadd', tx: Global.ln.get('window-mdtext-set'), ac: this.onOpen }, 
        ]));
