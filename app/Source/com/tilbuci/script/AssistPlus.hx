    ...
    **/
    public function new(ac:Dynamic) {
        ...
        this.setActions([
            ...
            //'system.pwainstall' => { p: [], s:false, c: false, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifhorizontal' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifvertical' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifwebsite' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifpwa' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifpwainstalled' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifdesktop' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifmobile' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifpublish' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
            'system.ifplayer' => { p: [], s:false, c: true, t: false, i: false, d:false, ic: 'icSystem' }, 
